...
\chapter{Neural Networks, Critical Points, and the No-Bad-Local-Minima Theory}\chapterlabel{one}
...
We choose the one that minimizes that inner product for its length,
...
but even this simple approach is sufficient to guarantee
...
gradient descent, \algoref{gd},
is sufficient to obtain global minima.
This covers many cases~\cite{stufffromlee2016}.
