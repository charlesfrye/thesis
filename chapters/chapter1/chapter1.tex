...
\begin{example}[float=hp]{1-Dimensional Deep Linear Autoencoder}{1ddlae}
	...
	\end{equation}
	In more standard, loose terminology,
...
\begin{example}{Gaussian Process}{gp}
	Choose $k = 1$ in the \defref{grf}.
	This special case of a Gaussian random field
	is called a \emph{Gaussian process}.

	Talk about applications. Show a figure.
\end{example}

Talk about the Gaussian process model for neural networks.
