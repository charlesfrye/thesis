...
\begin{table}[h]
	\begin{center}
		\begin{tabular}{rl}
			\textbf{Name}       & \textbf{Symbol} : \textbf{Type}        \\ %chktex 26
...
\begin{definition}{Kernel and Co-Kernel}{kernel}
...
The full rank of Wigner random matrices
is in stark contrast to that of Hessian matrices
...
\section{Conclusion}\sectionlabel{ch1-conclusion}
