...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\textwidth]{img/chapter1/convex_vs_nonconvex.pdf}
	\caption{\textbf{The Critical Points and Global Minima
	of a Convex and a Non-Convex Function}}{\textbf{A}:
	The convex function $L(\theta) = \theta^2$ (blue) and its critical points (gold)
	and minimizers (gray outline).
	\textbf{B}:
...
\subsection{Counterexamples to the No-Bad-Local-Minima Theory and Alternatives}\sectionlabel{counter}
