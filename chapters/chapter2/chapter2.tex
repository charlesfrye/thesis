...
\equationref{def-epscp} or \equationref{sqrteps}
...
\begin{definition}{Moore-Penrose Pseudo-Inverse}{pseudoinverse}
	...
	\begin{center}
	    \begin{tikzcd}
		    \R^n \arrow[rr, "M", bend left] \arrow[dd, "V^\top", two heads, bend right]
		    &  & \R^m \arrow[dd, "U^\top", two heads, bend right] \arrow[ll, "M^+", dotted, bend left]                       \\
		\ & \  & \\
