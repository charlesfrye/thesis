...
Firstly,
the $\argmin$ in \algoref{newtonLS-exact}
...
\begin{algorithm}[h]
    ...
    \While{$t < T$}{%
        ...
        $\alpha \leftarrow \textrm{BTLS}\left(
            \nabla f, p, \theta_t, \alpha, \beta, \rho, \rho^\prime, \eps\right)$\\
