...
These methods are relatively unfamiliar
to the neural network community.
First, second-order optimization methods,
...
We denote the set of all finite subsets of a set $S$ as
$\cP_\omega(S)$},
...
In a numerical setting,
this is set to the largest value for which
$\alpha = \beta\alpha$.
...
\begin{algorithm}[h]
	...
	\If{$\alpha < \eps$}{\alpha \leftarrow 0\;\textbf{break}\;}}
    }%
    $\KwRet\ \alpha$%
...
of their behavior when the Hessian is singular.
